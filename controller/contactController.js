                  ...
                  <tr>
                    <td style="padding:44px 42px 40px;">
                      <div style="margin-bottom:24px;">
                        ...
                        <p style="margin:0;color:#0f172a;font-size:16px;font-weight:600;">${name?name:"Anonymous"}</p>
                        <p style="margin:4px 0 0;color:#64748b;font-size:14px;">${email?email:"Anonymous"}</p>
                      </div>
